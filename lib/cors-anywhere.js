...
function onProxyResponse(response, req, res) {
  ...
  responseHeadersToRemove.forEach((key) => delete response.headers[key]);
  ...
  Object.keys(requestState.setResponseHeaders).forEach(function (key) {
    response[key] = requestState.setResponseHeaders[key];
  });
...
exports.createServer = function createServer(options) {
  ...
  const proxy = httpProxy.createServer(mergedOptions.httpProxyOptions);
