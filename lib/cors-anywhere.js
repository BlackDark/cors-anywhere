...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  // Object.keys(requestState.setResponseHeaders).forEach(function (key) {
  //   proxyRes[key] = requestState.setResponseHeaders[key];
  // });
...
exports.createServer = function createServer(options) {
  const defaultOptions = require('../server-config').getConfiguration();
