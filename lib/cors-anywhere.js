...
function withCORS(headers, request) {
  ...
  manipulatorConfig.responseHeadersToRemove.forEach((key) => delete headers[key]);
  ...
  Object.keys(manipulatorConfig.responseHeadersToSet).forEach(function (key) {
    headers[key] = manipulatorConfig.responseHeadersToSet[key];
  });
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  logger.debug('Response headers with customs: ' + JSON.stringify(proxyRes.headers));
